...
#include "qt/otherbamountfield.h"
...
//
//     src/qt/test/test_otherb-qt -platform xcb      # Linux
//     src/qt/test/test_otherb-qt -platform windows  # Windows
//     src/qt/test/test_otherb-qt -platform cocoa    # macOS
void TestSendCoins()
{
