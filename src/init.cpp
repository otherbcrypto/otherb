 ...
 * between otherbd, and otherb-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/otherb-project/otherb>";
    const std::string URL_WEBSITE = "<https://otherb.org>";
