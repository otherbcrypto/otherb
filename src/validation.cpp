...
#if defined(NDEBUG)
# error "otherb cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "otherb Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s OTB additional fees, %d delta bytes\n",
