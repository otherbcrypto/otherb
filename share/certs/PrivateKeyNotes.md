...
allowing somebody to distribute a Bitcoin-Qt.app or otherb-qt-setup.exe with a valid
...
that the otherb-qt.exe file inside the installer had not been tampered with.
