Bitcoin Core version 0.12.0 is now available from:
  ...
  <https://otherb.org/bin/otherb-core-0.12.0/>
...
(https://github.com/otherb/bips/blob/master/bip-0125.mediawiki).
...
notes of v0.11.0](https://github.com/otherb/otherb/blob/v0.11.0/doc/release-notes.md#block-file-pruning).
...
- #6269 `d4565b6` gitian: Use the new otherb-detached-sigs git repo for OSX signatures (Cory Fields)
...
- #6600 `ef4945f` Include otherb-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix otherb-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of otherb-cli on secp256k1 (Wladimir J. van der Laan)
...
- #6387 `11576a5` [otherb-cli] improve error output (Jonas Schnelli)
- #6401 `6db53b4` Add BITCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
- #6430 `b01981e` doc: add documentation for shared library libotherbconsensus (Braydon Fuller)
