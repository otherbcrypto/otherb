Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/otherb/files/Bitcoin/otherb-0.7.0/

We recommend that everybody running prior versions of otherbd/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/otherb/otherb/tarball/v0.7.0  # .tar.gz
  https://github.com/otherb/otherb/zipball/v0.7.0  # .zip
...
in your terminal, then install the otherb-qt package:
  sudo apt-get install otherb-qt
...
Core otherb handling and blockchain database
...
* Ensure a changed otherb unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for otherb-qt.exe
* (Windows only): add meta-data to otherb-qt.exe (e.g. description)
...
* Bash programmable completion for otherbd(1)
