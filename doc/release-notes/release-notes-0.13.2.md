Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://otherb.org/bin/otherb-core-0.13.2/>
...
- #8908 `4a974b2` Update otherb-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow otherb-tx to create v2 transactions (btcdrak)
