Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://otherb.org/bin/otherb-core-0.11.0/>
...
For example, add the following to `otherb.conf`:
...
related to the blockchain in the otherb system: the raw blocks as received over 
...
For an example script see [otherb-submittx](https://github.com/laanwj/otherb-submittx).
...
- #5334 `cf87536` libotherbconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new otherb-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add otherb logo to about screen
...
- #5809 `46bfbe7` Add otherb-cli man page
...
- #5849 `41259ca` contrib/init/otherbd.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for otherb-tx)
