Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://otherb.org/bin/otherb-core-0.11.1/>
...
(see https://github.com/otherb/otherb/pull/6795).
...
one was randomly violated by all deployed otherb software prior to
...
http://fc15.ifca.ai/preproceedings/otherb/paper_9.pdf
...
(see https://github.com/otherb/otherb/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libotherbconsensus: avoid a crash in multi-threaded environments
